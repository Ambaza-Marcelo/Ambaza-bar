        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form novalidate id="entryForm" action="{{ route('bars.update', $bar) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input autofocus type="text" class="form-control" name="name" value="{{$bar->name}}" required minlength="2" maxlength="255">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control" name="about" value="{{$bar->about}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input  type="text" class="form-control" name="adress" required value="{{$bar->adress}}" min="1" maxlength="10">
