        ...
        <div class="col-md-3" id="side-navbar">
            <ul class="nav flex-column">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('bars.index') }}"><span class="nav-link-text">@lang('Back to Manage bar')</span></a>
                </li>
            </ul>
        </div>
        @endif
        <div class="col-md-8" id="main-container">
            ...
            <div class="alert alert-success">
                ...
                @if (session('register_hotel_id'))
                    <a href="{{ url('bar/admin-list/' . session('register_hotel_id')) }}" target="_blank" class="text-white pull-right">@lang('View Admins')</a>
                @endif
            </div>
            @endif
