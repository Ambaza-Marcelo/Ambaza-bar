            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-30">
                        ...
                        <p>
                            Situé à côté de la route national 1, c'est l'environnement extérieur parfait pour dîner et se détendre. Que ce soit pour le petit-déjeuner, le déjeuner ou le dîner, Ambaza bar est l'endroit rafraîchissant pour commencer la journée ou se détendre. Venez savourer le mélange enchanteur de notre chef de cuisine européenne et africaine.</p>
                    </div> <!-- section title -->
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="single-services text-center">
                                    ...
                                    <div class="services-content mt-20">
                                        ...
                                        <p>Ambaza bar propose une expérience culinaire de qualité pour toutes les occasions et à tout moment de la journée. Assurez-vous de trouver les meilleures boissons. </p>
                                    </div>
                                </div> <!-- single services -->
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="single-services text-center mt-30">
                                    ...
                                    <div class="services-content mt-20">
                                        ...
                                        <p>
Des événements VIP, cocktails, banquets, dîners, expositions, défilé de mode, mariages, Ambaza bar  propose ses espaces fonctionnels pour des évènements complètement personnalisés.</p>
                                    </div>
                                </div> <!-- single services -->
                                ...
                                <div class="single-services text-center mt-30">
                                    ...
                                    <div class="services-content mt-20">
                                        ...
                                        <p>
Laissez tout stress derrière vous et dorlotez votre corps, votre esprit et votre âme dans le pavillon de massage unique au bord de la piscine, soutenu par une bouffée d'air frais</p>
                                    </div>
                                </div> 
                            </div>
                        </div> 
    ...
    <section id="showcase" class="showcase-area pt-100 pb-130">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="showcase-title pt-25">
                        <p>Ouvert toute la journée jusqu'à tard, Ambaza Bar propose toutes les boissons que vous pourriez désirer et un menu de collations et de repas pour répondre à toutes les envies.</p>
                    </div> <!-- showcase title -->
                </div>
            </div> <!-- row -->
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-sm-7">
                        <div class="footer-logo mt-40">
                            ...
                            <p class="mt-10">Ouvert toute la journée jusqu'à tard, Ambaza Bar propose toutes les boissons que vous pourriez désirer et un menu de collations et de repas pour répondre à toutes les envies.</p>
